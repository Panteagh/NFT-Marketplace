...
function ArtistCard({ id, name, Avatar }) {
  return (
    <div className="bg-[#3B3B3B] rounded-3xl lg:w-60 lg:h-[238px] relative w-full md:h-[100px] max-sm:h-[100px] my-3 hover:scale-95 duration-700 ">
      <div className="bg-[#2B2B2B] text-[#858584] rounded-full w-8 h-8 lg:text-center absolute top-5 lg:left-5 md:top-3 sm:top-3 md:left-14 max-md:left-10 max-sm:top-4 lg:pt-[3px] lg:pr-[10px] max-lg:p md:pl-[10px] md:pt-[2px] sm:pl-[12px] sm:pt-[2px] max-sm:pl-3 max-sm:pt-1">
        {id}
      </div>
