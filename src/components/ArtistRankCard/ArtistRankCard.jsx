  ...
  return (
    <div className='lg:h-20 max-md:h-14 rounded-3xl bg-[#3B3B3B] hover:scale-95 duration-700 '>
      ...
      <div className='flex gap-6 justify-center items-center basis-[360px] text-left lg:mt-3 max-lg:mt2 max-md:mt-0'>
        <img className='lg:w-[60px] lg:h-[60px] max-lg:w-[50px] max-lg:h-[50px] max-md:w-12 max-md:h-12  max-lg:my-3 max-md:my-1 basis-[60px]' src={Avatar} />
        <h2 className='text-white text-left basis-[300px] text-2xl font-bold max-md:text-lg'>{name}</h2>
      </div>
      <span className='basis-40 text-[#00AC4F] max-sm:hidden'>+1.41%</span>
      <span className='basis-40 font-mono text-white max-md:hidden '>602</span>
