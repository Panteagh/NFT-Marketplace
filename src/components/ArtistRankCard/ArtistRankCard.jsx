...
function ArtistRankCard({ id, Avatar, Artistname }) {
  return (
    <div className="lg:h-20 px-5 max-sm:pr-3 max-md:h-14 rounded-3xl bg-[#3B3B3B] hover:scale-95 duration-700">
      <div className="flex justify-around items-center mt-6">
        ...
        <span className="basis-40 text-[#00AC4F] max-sm:hidden max-md:text-sm">+1.41%</span>
        <span className="basis-40 font-mono text-white max-md:hidden ">
          602
        </span>
        <span className="basis-40 font-mono text-white max-md:text-sm">12.4 ETH</span>
      </div>
    </div>
  );
}
