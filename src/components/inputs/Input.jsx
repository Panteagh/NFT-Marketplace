...
function Input({ label, icon, button, style }) {
  ...
  const { inputValue } = useNftMarketPlaceContext ();
  return (
    <div>
      <div className="[--clr:#1f1f1f] dark:[--clr:#999999] relative flex flex-row items-center mt-7">
        <input
          ...
          id={label}
          type="text"
          className="peer text-black pl-2 h-[40px] min-h-[40px] pr-[40px] leading-normal appearance-none resize-none box-border text-base w-full text-inherit block text-left border border-solid bg-white rounded-2xl m-0 p-0 outline-0 focus-visible:outline-0 focus-visible:border-purple-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#71717a2e] dark:focus-visible:ring-[#14b8a61a]"
        />
